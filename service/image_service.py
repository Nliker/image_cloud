...
class ImageService:
    ...
    #route("/image POST")
    def save_image(self,image,filename,user_id,public):
        ...
        new_image_id=self.image_dao.insert_image(user_id,link,public)
        return new_image_id

    def get_image_links(self,start,end):
        return self.image_dao.get_image_links(start,end)
    
    def get_user_image_links(self,user_id,start,end,public):
        return self.image_dao.get_image_links_by_user_id(user_id,start,end,public)
